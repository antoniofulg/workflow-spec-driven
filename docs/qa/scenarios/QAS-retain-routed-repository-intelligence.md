...
entry_points: .agents/skills/workflow-spec-driven/scripts/repository_intelligence.py benchmark-report; README.md#repository-intelligence; docs/toolkit/repository-intelligence.md
qa_status: untested
bug_ids:
fix_status:
retest_status:
