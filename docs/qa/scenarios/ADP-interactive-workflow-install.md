...
Retired — its prior package-specific interactive promise was folded into the current canonical
`ADP-adopt-workflow-safely` and exact-local-package scenarios.
