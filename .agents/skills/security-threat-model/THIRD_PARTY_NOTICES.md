...
Modified synthesis of [OpenAI security-threat-model](https://github.com/openai/skills/tree/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/security-threat-model).
Source commit: `49f948faa9258a0c61caceaf225e179651397431`.
Source and [skill-local license](https://github.com/openai/skills/blob/49f948faa9258a0c61caceaf225e179651397431/skills/.curated/security-threat-model/LICENSE.txt)
checked on 2026-09-12. No relevant upstream NOTICE file exists in this skill.

Repository evidence, assets, boundaries, abuse paths, separate execution planes,
likelihood/impact, material-assumption check-in, concise output and Mermaid.
The upstream prompt and asset/control references were condensed into this skill's
entrypoint and two references.
