...
class WtkForwardTests(unittest.TestCase):
    ...
    def test_conditional_integrations(self) -> None:
        ...
        self.assertIn("docs/guidelines/SECURITY.md", ROUTER)
        ...
        self.assertIn("docs/guidelines/UI-UX.md", ROUTER)
        adopted = (ROOT / "templates/adoption/agents/core.md").read_text(encoding="utf-8")
        self.assertIn("docs/guidelines/SECURITY.md", adopted)
        self.assertIn("docs/guidelines/UI-UX.md", adopted)
