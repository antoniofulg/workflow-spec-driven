...
| Plan or Specify: runtime, config, public behaviour, authentication, authorization | `docs/guidelines/SECURITY.md` — before coding; use sections 2 and 3 at their named phases |
| Design or Build: screen or interaction | `docs/guidelines/UI-UX.md` — before Design or Build; use the feature `uiux.md` when present |
