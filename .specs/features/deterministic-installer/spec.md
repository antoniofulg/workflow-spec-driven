...
| DINST-002 | P1: fresh exact-release apply | Execute | Implemented in T4 |
...
| DINST-010 | P2: package allowlist and no hooks/downloads | Execute | Implemented in T4 |
...
| SEC-004 | Security: package contents | Execute | Implemented in T4 |
